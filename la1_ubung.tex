...
\begin{document}
	...
	\begin{enumerate}[label=(\alph*)]
		...
		\item Zeigen Sie: Die Polynome $$P = [1]X^{3} + [1]X^{2} + [2]X + [1]$$ und $$Q = [1]X^{2} + [1]$$ sind verschiedene Elemente von $(\mathbb{Z}/3\mathbb{Z})[X]$, aber definieren die gleiche Funktion $\mathbb{Z}/3\mathbb{Z} \to \mathbb{Z}/3\mathbb{Z}$ (d.h. $ev(P) = ev(Q)$).
